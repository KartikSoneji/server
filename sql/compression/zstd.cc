...
struct zstd_handler_st zstd_handler = {
   DUMMY_ZSTD_compress,
   DUMMY_ZSTD_compressBound,
   DUMMY_ZSTD_compress_usingCDict,
   DUMMY_ZSTD_compress_usingDict,
   DUMMY_ZSTD_createCCtx,
   DUMMY_ZSTD_createCCtx_advanced,
   DUMMY_ZSTD_createCDict,
   DUMMY_ZSTD_createDCtx,
   DUMMY_ZSTD_createDCtx_advanced,
   DUMMY_ZSTD_createDDict_byReference,
   DUMMY_ZSTD_decompress,
   DUMMY_ZSTD_decompress_usingDDict,
   DUMMY_ZSTD_decompress_usingDict,
   DUMMY_ZSTD_freeCCtx,
   DUMMY_ZSTD_freeCDict,
   DUMMY_ZSTD_freeDCtx,
   DUMMY_ZSTD_freeDDict,
   DUMMY_ZSTD_getErrorName,
   DUMMY_ZSTD_isError,
   DUMMY_ZSTD_sizeof_DDict,
   DUMMY_ZSTD_versionNumber
};


struct zstd_handler_st *zstd_handler_ptr = &zstd_handler;
...
void init_zstd(){
   ...
   zstd_handler.ZSTD_compress_ptr                  = (PTR_ZSTD_compress)                   ZSTD_compress_ptr;
   zstd_handler.ZSTD_compressBound_ptr             = (PTR_ZSTD_compressBound)              ZSTD_compressBound_ptr;
   zstd_handler.ZSTD_compress_usingCDict_ptr       = (PTR_ZSTD_compress_usingCDict)        ZSTD_compress_usingCDict_ptr;
   zstd_handler.ZSTD_compress_usingDict_ptr        = (PTR_ZSTD_compress_usingDict)         ZSTD_compress_usingDict_ptr;
   zstd_handler.ZSTD_createCCtx_ptr                = (PTR_ZSTD_createCCtx)                 ZSTD_createCCtx_ptr;
   zstd_handler.ZSTD_createCCtx_advanced_ptr       = (PTR_ZSTD_createCCtx_advanced)        ZSTD_createCCtx_advanced_ptr;
   zstd_handler.ZSTD_createCDict_ptr               = (PTR_ZSTD_createCDict)                ZSTD_createCDict_ptr;
   zstd_handler.ZSTD_createDCtx_ptr                = (PTR_ZSTD_createDCtx)                 ZSTD_createDCtx_ptr;
   zstd_handler.ZSTD_createDCtx_advanced_ptr       = (PTR_ZSTD_createDCtx_advanced)        ZSTD_createDCtx_advanced_ptr;
   zstd_handler.ZSTD_createDDict_byReference_ptr   = (PTR_ZSTD_createDDict_byReference)    ZSTD_createDDict_byReference_ptr;
   zstd_handler.ZSTD_decompress_ptr                = (PTR_ZSTD_decompress)                 ZSTD_decompress_ptr;
   zstd_handler.ZSTD_decompress_usingDDict_ptr     = (PTR_ZSTD_decompress_usingDDict)      ZSTD_decompress_usingDDict_ptr;
   zstd_handler.ZSTD_decompress_usingDict_ptr      = (PTR_ZSTD_decompress_usingDict)       ZSTD_decompress_usingDict_ptr;
   zstd_handler.ZSTD_freeCCtx_ptr                  = (PTR_ZSTD_freeCCtx)                   ZSTD_freeCCtx_ptr;
   zstd_handler.ZSTD_freeCDict_ptr                 = (PTR_ZSTD_freeCDict)                  ZSTD_freeCDict_ptr;
   zstd_handler.ZSTD_freeDCtx_ptr                  = (PTR_ZSTD_freeDCtx)                   ZSTD_freeDCtx_ptr;
   zstd_handler.ZSTD_freeDDict_ptr                 = (PTR_ZSTD_freeDDict)                  ZSTD_freeDDict_ptr;
   zstd_handler.ZSTD_getErrorName_ptr              = (PTR_ZSTD_getErrorName)               ZSTD_getErrorName_ptr;
   zstd_handler.ZSTD_isError_ptr                   = (PTR_ZSTD_isError)                    ZSTD_isError_ptr;
   zstd_handler.ZSTD_sizeof_DDict_ptr              = (PTR_ZSTD_sizeof_DDict)               ZSTD_sizeof_DDict_ptr;
   zstd_handler.ZSTD_versionNumber_ptr             = (PTR_ZSTD_versionNumber)              ZSTD_versionNumber_ptr;
